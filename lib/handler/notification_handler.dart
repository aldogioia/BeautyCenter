...
class NotificationHandler {
  ...
  static Future<void> handleNotificationPermissions() async {
    ...
    final notificationEnabled = await SecureStorage.getNullableNotificationsEnabled();

    await SecureStorage.saveNotificationsEnabled(notificationEnabled ?? granted ?? false);
  }
